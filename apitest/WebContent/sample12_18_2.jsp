...
<script type="text/javascript">
    ...
    naver.maps.Event.addListener(infowindow<%=i%>, "click", function (e) {
        // 클릭 이벤트 처리
        var html = +'<span style="font-size: 20px; font-weight: bold;">' + <%=name.get(i)%> + ' </span><span style="color: red">';

        var markethomeElement = document.getElementById('markethomeContent');
        if (markethomeElement) {
            markethomeElement.innerHTML = html;
        }
    });
