...
function generateContent(data) {
    var html =
        '<div id="' + data.name + '" style="width: 320px; position:relative;">'	
		...
		+'<div id="menu" style="font-size:14px; padding: 0 3px 0 4px; display: flex; justify-content: space-between;"><span>짜장면</span><span style="align-items: flex-end">5000원</span></div>'
		+'<div id="menu" style="font-size:14px; padding: 0 3px 0 4px; display: flex; justify-content: space-between;"><span>쨈뽕</span><span style="align-items: flex-end">6000원</span></div>'
		+'<div id="menu" style="font-size:14px; padding: 0 3px 0 4px; display: flex; justify-content: space-between;"><span>곱배기</span><span style="align-items: flex-end">1000원 추가</span></div>'
        + '<hr>'
        + '<div style="display: flex; justify-content: space-between; margin-bottom:3px">'
