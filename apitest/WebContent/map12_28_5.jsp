	...
	function showCurrentLocationMarkers() {
	    ...
	    <% for (int i = 0; i < name.size(); i++) { %>
	        ...
	        if (bounds.hasLatLng(markerPosition<%= i %>)) {
	            ...
	            document.getElementById("values").innerHTML += '<li style="list-style:none; border: 1px solid black;" ><strong>' + '<%=name.get(i)%>' + '</strong>&nbsp;&nbsp;<span style="color:gray; font-size:13px;">' + '<%=phone.get(i)%>' + '</span>'
