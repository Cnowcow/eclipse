...
<script type="text/javascript">
	...
	<%}%>
		...
		function generateContent(data) {
		    var html = '<span style="font-size: 20px; font-weight: bold;">' + data.name + ' </span><span style="color: red">'
		    		+'★</span>4.7&nbsp;<span style="color: skyblue"><a href="#">후기(421건)</a></span><br><br>'
		    	    ...
		    	    +'<span style="font-size: 17px; font-weight: bold;">파티목록(5)</span><a href="#">(더보기)</a><br>'
		    	  	+'파티들어갈곳<br><br><br><br>'
					+'<hr>'
		    	    +'<div><a href="#"><button style="background-color: lightgreen; width: 70px; border-radius: 20px; text-align: center; padding-bottom: 2px;">홈</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
		    	    ...
		    	    +'<a href="#"><button style="background-color: lightgreen; width: 70px; border-radius: 20px; text-align: center; padding-bottom: 2px;">파티</button></a>'
					+'</div>'
		    		;
