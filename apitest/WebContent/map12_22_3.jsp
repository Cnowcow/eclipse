			...
			<% for (int i = 0; i < name.size(); i++) { %>
				...
				var contentString<%= i %> = `
					<a href="./home1.jsp#<%= name.get(i) %>" target='here'>
						<div id="infoWindowContent<%= i %>" style="border:1px solid #0098ff; border-radius:20px; padding:10px; background-color:#A7EEFF" 
							class="info" onclick="showMarketInfo()">
								<span style="color:black"><strong><%=name.get(i)%></strong></span>
						</div>
					</a>`;
...
<div style="position: absolute;">
	<jsp:include page="hf/header.jsp"></jsp:include>
		...
		<i class="bi bi-x-lg" style="font-size:20px; color: rgba(128, 128, 128, 0.5);" onclick="hideIframe()"></i>
		<iframe name="here">
		</iframe>
 		</div>
