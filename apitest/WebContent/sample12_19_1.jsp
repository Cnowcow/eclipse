...
<script type="text/javascript">
	...
	var contentString<%= i %> = `
		<a href="./markethome1.jsp#<%= name.get(i) %>" target='here' >
			<div style="padding:10px;" class="info" onclick="showMarketInfo('<%= name.get(i) %>', '<%= addr.get(i) %>', '<%= phone.get(i) %>')">
				<h4><%=name.get(i)%></h4>
			</div>
		</a>`;
...
<body>
	...
	<div class="module">
	        ...
	        <div class="menu_for_nav">
	            <header>
	                <div class="row">
	                    <div class="col"style="padding: 16px 0 0 12px;">
	                    	<i style="padding: 0 0 0 12px;" class="bi bi-list" onclick="hideMenu()"></i>
	                    </div>
